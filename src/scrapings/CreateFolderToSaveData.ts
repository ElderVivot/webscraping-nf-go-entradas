...
const mountFolder = (settings: ISettingsNotes, folder: string) => {
...
export async function createFolderToSaveData (settings: ISettingsNotes, folderRoutineAutomactic = false): Promise<string> {
